...
Qrcode is a focused project in this monorepo that delivers a practical tool with a clean user experience across platforms.

## ✨ 2. Features

1. [x] Core functionality tailored to Qrcode
...
- 🌐 [Live Demo](https://hieudoanm.github.io/qrcode/)

## 🚀 4. Usage

- 🌐 [Web](https://hieudoanm.github.io/qrcode/)
- 💻 [CLI](https://github.com/hieudoanm/qrcode/releases)
- 📱 [Mobile](https://github.com/hieudoanm/qrcode/releases)
- 🖥️ [Desktop](https://github.com/hieudoanm/qrcode/releases)
  - 🍎 [MacOS](https://github.com/hieudoanm/qrcode/releases/tag/macos-latest)
  - 🐧 [Ubuntu](https://github.com/hieudoanm/qrcode/releases/tag/ubuntu-latest)
  - 🪟 [Windows](https://github.com/hieudoanm/qrcode/releases/tag/windows-latest)
